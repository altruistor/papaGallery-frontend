...
const HomePage = () => (
  ...
  <div className="max-w-xl text-left whitespace-break-spaces relative">
    ...
    <p className="text-lg mb-2 text-white font-sans text-start sm:text-end">
              Художник, график,<br />изобретатель</p>
            <p className="text-xs mb-2 text-white font-sans text-start sm:text-end">Разрабатывал электронную технику 28 лет в Армии<br /> и 26 лет после неё</p>
            <p className="text-xs mb-2 text-white font-sans text-start sm:text-end">Фанат карандашной графики с придумками</p>
